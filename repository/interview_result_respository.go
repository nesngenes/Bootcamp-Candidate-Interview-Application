...
func (cr *interviewResultRepository) Create(payload model.InterviewResult) error {
...
func (cr *interviewResultRepository) Update(payload model.InterviewResult) error {
...
func (cr *interviewResultRepository) Delete(id string) error {
